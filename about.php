        ...
        <div class="container">
            <div class="row">
                <div class="bottom-align-text col-sm-6">
                    ...
                    <p itemprop="description">G.K Logistics is one of the most reputed, leading and reliable organization in Cargo and Logistics Industry, managed by an experienced team of qualified, dedicated professionals and equipped with the latest Information Technology. The company over the span of 15 years has dynamically grown at domestic probabilities which gives complete business solution in industry with unlimited service destinations across county.</p>
                    <br>
                    <br>
                    <br>
                    <br>
                ...
                <div class="col-md-6">
                    <div class="about-shipment-thumb">
                        <img src="img/about-shipment-thumb.jpg" alt="" itemprop="image" />
                    </div>
                </div>
