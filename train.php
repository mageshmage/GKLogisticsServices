...
<header>
    <div align="middle" class="header-content">
        <div class="header-content-inner">
            <h1 id="homeHeading">Trust is Our First Success</h1>
            <hr>
            <p>We Provide Best Cargo Service Through Air and Earth Movers!</p>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div >
                    <img src="img/train.jpg" class="img-rounded" alt="Cinque Terre" width="600" height="500">
                </div>
            </div>
